...
assert_contains "${install_agent}" "RUN_UID="
assert_contains "${install_agent}" "id -gn"
assert_contains "${install_agent}" "host-agent service must run as a non-root user"
assert_contains "${install_agent}" "chown -R"
assert_contains "${install_agent}" "User="
assert_contains "${install_agent}" "SupplementaryGroups=dialout"
assert_contains "${install_agent}" "If this is the first time the user was added to dialout"
